...
def select_archiver(directory, exclude_extensions=None):
    """
...
def main():
    ...
    contents, efficiency = select_archiver(args.directory, exclude_extensions=set(args.exclude) if args.exclude else None)
